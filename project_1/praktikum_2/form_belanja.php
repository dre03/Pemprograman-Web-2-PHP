	...
	<div class="row">
        ...
        <div class="row">
            ...
            <?php
                    ...
                    echo '<span class="text-white">'."Nama Customer : ".$Customer; '<span>';
                    echo '<br><span class="text-white">'."Produk Pilihan : ".$produk; '<span>';
                    echo '<br><span class="text-white">'."Jumlah Beli : ".$jumlah; '<span>';
                    echo '<br><span class="text-white">'."Harga Total : ".$harga; '<span>';
                ?>
            </div>
        </div>
	</div>
